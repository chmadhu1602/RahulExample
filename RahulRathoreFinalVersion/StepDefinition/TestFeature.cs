...
{
    [Binding]
    public sealed class TestFeature: BaseClass
    {
        ...
        {
            Assert.AreEqual("Enter Bug: TestProduct", ObjectRepository.ePage.Title);
        }
        ...
        {
            Assert.AreEqual("Enter Bug: TestProduct", bPage.Title);
        }
